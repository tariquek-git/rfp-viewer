    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-blue-50">
      <div className="bg-white rounded-2xl p-10 w-full max-w-sm shadow-xl border border-gray-100">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-gray-900 text-2xl font-bold mb-1 tracking-tight">BSB RFP Workbook</h1>
          <p className="text-gray-400 text-sm">Brim Financial — Internal Use</p>
        </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">Confidential · Brim Financial</p>
      </div>
    </div>
  );
}
