      ...
      >
        ...
        <div className="text-center mb-20 print:mb-16">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-3">
            BSB Credit Card Program
          </h1>
          <h2 className="text-xl text-gray-500 dark:text-gray-400 font-normal border-0 mb-8">
        ...
        {(mode === 'full' || mode === 'executive') && (
          <div className="mb-16 print:break-before-page">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white border-b-2 border-gray-900 dark:border-gray-100 pb-2 mb-6">
              Executive Overview
            </h2>
                ...
                <table className="risk-table w-full text-xs border-collapse">
                  <thead>
                    <tr className="bg-gray-50 dark:bg-gray-800">
                      <th className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-left font-semibold">
                        Ref
                      </th>
                      <th className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-left font-semibold">
                        Topic
                  ...
                  <tbody>
                    {stats.redQuestions.map((q) => (
                      <tr key={q.ref}>
                        <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 font-mono">
                          {q.ref}
                        </td>
                        <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5">
                          {q.topic}
                        </td>
                        <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-red-600 font-bold">
                          {q.committee_score}/10
                        </td>
                        <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-gray-600 dark:text-gray-400">
            ...
            {/* Category scorecard */}
            <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-3 mt-8">
            ...
            <table className="w-full text-xs border-collapse mb-8">
              ...
              <tbody>
                {catStats.map((s) => (
                  <tr key={s.cat}>
                    <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 font-medium">
                      {s.cat}
                    </td>
                    <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-center">
                      {s.count}
                    </td>
                    <td
                      className={`border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-center font-bold ${s.avg >= 7 ? 'text-emerald-600' : s.avg >= 5 ? 'text-amber-600' : 'text-red-600'}`}
                    >
                      {s.avg.toFixed(1)}
                    </td>
                    <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-center text-emerald-600">
                      {s.green}
                    </td>
                    <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-center text-amber-600">
                      {s.yellow}
                    </td>
                    <td className="border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-center text-red-600">
                      {s.red}
                    </td>
                  </tr>
                ))}
        ...
        {mode !== 'executive' && (
          <div className="mb-12 print:break-before-page">
            <h2 className="text-lg font-bold text-gray-900 dark:text-white border-b-2 border-gray-900 dark:border-gray-100 pb-2 mb-4">
              Table of Contents
            </h2>
            <ol className="space-y-2">
              {categories.map((cat, i) => {
                ...
                return (
                  <li
                    key={cat}
                    className="flex items-center justify-between text-sm border-b border-dotted border-gray-200 dark:border-gray-700 pb-1"
                  >
