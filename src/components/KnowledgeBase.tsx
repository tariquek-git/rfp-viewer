    ...
    <div className="overflow-auto h-full p-6 bg-gray-50/30">
      <div className="max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                These facts are injected into every AI rewrite prompt to ensure consistency and
                accuracy.
              </p>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <KBSection
            label="Company Facts"
            description="Key facts about Brim Financial: founding, FI partnerships, platform capabilities, team size, etc."
            value={kb.companyFacts}
            onChange={(v) => update('companyFacts', v)}
          />

          <KBSection
            label="Key Metrics"
            description="Numbers the AI should cite: FI launches, transaction volumes, uptime, response times, etc."
            value={kb.keyMetrics}
            onChange={(v) => update('keyMetrics', v)}
          />

          <KBSection
            label="Differentiators"
            description="What makes Brim unique vs. competitors: technology advantages, platform features, approach."
          ...
          <KBSection
            ...
            description="How Brim positions against specific competitors, market gaps Brim fills."
