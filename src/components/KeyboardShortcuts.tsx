...
export default function KeyboardShortcutsPanel({ onClose }: { onClose: () => void }) {
 ...
 <kbd
 key={j}
 className="px-1.5 py-0.5 bg-gray-100 rounded text-[11px] font-mono border border-gray-200 text-gray-600 min-w-[24px] text-center"
 >
 {k}
 </kbd>
 ))}
 ...
 Press{' '}
 <kbd className="px-1 py-0.5 bg-gray-100 rounded text-[10px] font-mono border border-gray-200">
 ?
 </kbd>{' '}
 to toggle
 </span>
