      ...
      <div className="absolute right-0 top-0 bottom-0 w-[480px] bg-white dark:bg-gray-900 border-l shadow-2xl z-30 flex flex-col panel-slide-in">
        ...
        <div className="flex-1 overflow-auto p-5 space-y-4">
          ...
          {themeCoverage.map(({ theme, covered, total, pct }) => (
            <div
              key={theme.id}
              className="border border-gray-200 dark:border-gray-700 rounded-xl p-4 group"
            >
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
            ...
            <textarea
              ...
              rows={2}
              className="w-full border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 text-sm mb-2 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none"
            />
            <button
              onClick={addTheme}
